...
export default function Home() {
  ...
  async function fetchPagedStocks(
    ...
    try {
      ...
      setDataDate(
        data.data_date || data.source_summary?.twse_data_date || data.source_summary?.tpex_data_date || "-"
      );
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ color: "#ffd95f", fontSize: "18px", fontWeight: 900, whiteSpace: "nowrap" }}>
                          分數 {stock.score ?? 0}
                        </div>
                      </div>
